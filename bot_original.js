...
(function () {
    ...
    function switchTab(tab) {
        ...
        if (tab === 'planner') {
            ...
            btnFarm.style.background = '#1a2a1a';
    ...
    async function procesarAutoBuild() {
        ...
        const multiCity = document.getElementById('chk-multi-city')?.checked || false;
    ...
    async function construirAlgo() {
        ...
        const queueText = win.querySelector('#main_tasks h4')?.innerText || "";
    ...
    async function procesarAutoRecruit() {
        ...
        const cantidad = document.getElementById('recruit-amount')?.value || 10;
        const multiCity = document.getElementById('chk-multi-city')?.checked || false;
    ...
    async function verificarVentanaRecruit() {
        ...
        if (wins.length > 0) {
            ...
            res.innerHTML = `<div style="color:#f00;">❌ NO veo Cuartel ni Puerto. Ábrelo.</div>`;
        }
    }
    ...
    async function verificarVentanaAgora() {
        ...
        if (win) {
            ...
            res.innerHTML = `<div style="color:#f00;">❌ NO veo el Ágora. Ábrela.</div>`;
        }
    }
    ...
    async function procesarSuperAuto() {
        const resultado = document.getElementById('resultado');
        const intervalMin = parseInt(document.getElementById('auto-interval')?.value) || 15;
        const multiCity = document.getElementById('chk-multi-city')?.checked || false;
